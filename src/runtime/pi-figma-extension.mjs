...
module.exports = function(pi) {
  ...
  reg("figma_export_assets", "Export Figma nodes as high-resolution PNG/SVG/PDF/JPG on the host, save full files, and attach a readable preview when possible. Default PNG scale is 4x.", { fileKey: { type: "string" }, nodeIds: { type: "array", items: { type: "string" } }, format: { type: "string", enum: ["png", "svg", "pdf", "jpg"] }, scale: { type: "number", description: "Export scale, default 4 for readable small text" } }, ["fileKey", "nodeIds"], "export_assets");
