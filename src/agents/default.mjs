...
- Jira-triggered turns: if the latest event is one of your own prior comments/status updates and contains no new external feedback, do not add another Jira comment. Summarize briefly and stop to avoid self-trigger loops.
